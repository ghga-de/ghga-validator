> [!IMPORTANT]
> **GHGA Validator has moved.** Development continues in the GHGA monorepo at [ghga-de/ghga](https://github.com/ghga-de/ghga), under `tools/$repo_name`. This repository is being archived and will become read-only; please open issues and pull requests in the monorepo. The `$repo_name` package on PyPI is unaffected; future releases are published from the monorepo.
