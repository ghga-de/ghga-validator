...
def test_validate_backref():
    """Test BackRefValidationPlugin"""
    schema = BASE_DIR / "schemas" / "submission.yaml"
    file = BASE_DIR / "data" / "example_data_submission.json"
    ...
    file = BASE_DIR / "data" / "example_data_submission_wrong.json"
